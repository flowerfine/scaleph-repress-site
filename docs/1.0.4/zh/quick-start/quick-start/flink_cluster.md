...
![create_project](./images/cluster/create_project.png)

在`集群管理 -> 集群配置` 创建集群配置模板：

![cluster_config_01](./images/cluster/cluster_config_01.png)

![cluster_config_02](./images/cluster/cluster_config_02.png)

如果集群模板选择了 Session 类型，则需进一步在 `集群管理 -> 集群实例` 创建模板对应的 Session 集群：

![cluster_instance_01](./images/cluster/cluster_instance_01.png)

![cluster_instance_02](./images/cluster/cluster_instance_02.png)
